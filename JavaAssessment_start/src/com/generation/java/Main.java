...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        //TODO - ATTEMPTED - Loop through the student enrolled courses, and use the scanner object to get the course ID to insert the course grade
//        String courseInput = scanner.next();
//        Course inputSearch = studentService.findEnrolledCourse(student, courseInput);
//        if (courseInput != inputSearch.getCode()){
